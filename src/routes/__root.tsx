...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "SM Tours & Travels — Bangalore Cabs & Outstation" },
      { name: "description", content: "Reliable cabs in Bangalore. Airport transfers, outstation, tour packages. 24/7." },
      { name: "author", content: "SM Tours and Travels" },
